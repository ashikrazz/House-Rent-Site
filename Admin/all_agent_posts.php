    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Agent Posts</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">All Agent Posts List</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Agent Name</th>
                      <th class="text-secondary opacity-7"></th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                  $query = "SELECT * FROM `create_post` as c,`agents` as a WHERE c.agent_id = a.agent_id ORDER BY c.post_id DESC ";
                  $agent_post = mysqli_query($con,$query);
                  $count = 1;
                  while ($row = mysqli_fetch_array($agent_post)){
                  ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="../post_image/<?php echo $row['post_image'] ?>" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                          </div>
