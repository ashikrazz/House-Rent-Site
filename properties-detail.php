...
<html lang="en">
  <head>
    ...
    <title>House Rent | Agent Properties Details</title>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-property-header-inner">
            <h2>Agent Properties Details</h2>
            <ol class="breadcrumb">
            <li><a href="index.php">HOME</a></li>
  ...
  <section id="aa-properties">
    <div class="container">
      <div class="row">
          <?php
                  $query = "SELECT * FROM `create_post` as c ,`agents` as a  WHERE c.post_id = $id AND c.agent_id=a.agent_id ";
          ...
          <div class="aa-properties-content">            
            ...
            <div class="aa-properties-details">
             <div class="aa-properties-details-img">
               <img src="post_image/<?php echo $row['post_image'] ?>" alt="img">
             </div>
             <div class="aa-properties-info">
               ...
               <ul>
                 <li>Property For : <?php echo $row['post_category'] ?></li>
                 <li>Property Type : <?php echo $row['post_type'] ?></li>
                 ...
                 <h4>Agent Contact</h4>
                 <ul>
                     <li>Agent Name : <?php echo $row ['name']?> </li>
                     <li>Agent Phone : <?php echo $row ['phone']?> </li>
                     <li>Agent Email : <?php echo $row ['email']?></li>
                 </ul>
             </div>
            </div>           
          </div>
