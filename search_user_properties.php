...
<section id="aa-latest-property">
    <div class="container">
        <div class="aa-latest-property-area">
            <div class="aa-title">
                <h2>User Properties Search Results</h2>
                <span></span>
            </div>
            <div class="aa-latest-properties-content">
                <div class="row">
                    ...
                    if (isset($_GET['user_search'])){
                        $user_post_category = $_GET['user_post_category'];
                        $user_post_type = $_GET['user_post_type'];
                        $sublet = $_GET['sublet'];
                        $month = $_GET['month'];
                        $post = mysqli_query($con,"SELECT * FROM `create_user_post` WHERE `user_post_category` = '$user_post_category' AND `user_post_type` = '$user_post_type' AND `sublet` = '$sublet' AND `month` = '$month' ORDER BY `user_post_id` DESC LIMIT 18446744073709551610");
                    }
                    $count = 1;
