        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
                    ...
                    <li class="active"><a href="user_properties.php">USER PROPERTIES</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="aa-property-header-inner">
                    <h2>User Properties Page</h2>
                    <ol class="breadcrumb">
                        <li><a href="index.php">HOME</a></li>
                        <li class="active">USER PROPERTIES</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="aa-properties-content">
                    ...
                    <div class="aa-properties-content-body">
                        <ul class="aa-properties-nav">
                            <?php
                            $query = "SELECT * FROM `create_user_post` ORDER BY `user_post_id` DESC ";
                            ...
                            while ($row = mysqli_fetch_array($posts)){
                                ...
                                <li>
                                    <article class="aa-properties-item">
                                        <a class="aa-properties-item-img" href="user_properties-detail.php?id=<?php echo $row['user_post_id']?>">
                                            <img alt="img" src="post_image/<?php echo $row['user_post_image']?>" height="240px" width="370px">
                                        </a>
            ...
            <div class="col-md-3">
                <aside class="aa-properties-sidebar">
                    ...
                    <div class="aa-properties-single-sidebar">
                        ...
                        <form action="search_user_properties.php" method="get">
                            <div class="aa-single-advance-search">
                                <label for="user_post_category">Post for </label>
                                <select id="user_post_category" name="user_post_category">
                            ...
                            <div class="aa-single-advance-search">
                                <label for="user_post_type">Post Type </label>
                                <select id="user_post_type" name="user_post_type">
                            ...
                            <div class="aa-single-advance-search">
                                <input type="submit" value="Search" class="aa-search-btn" name="user_search">
                            </div>
                        </form>
                    </div>
                </aside>
