...
<div class="container">
    <div class="main-body">
        ...
        <div class="container_one">
            <form action="save_user_post.php" method="post" enctype="multipart/form-data">
                ...
                ?>
                <input type="number" id="user_id" name="user_id" placeholder="Your User Id is <?php echo $res['user_id'] ?>"><br>
